#!/bin/bash
# CodeCompanion — Phase 7 Setup Script
# Revenue Analytics module — projections, trends, DAR, benchmarks
# Run from repo root: bash setup-phase7.sh

set -e
echo "🏗️  Building Phase 7 — Revenue Analytics..."
...
EOF
echo "✓ app/(dashboard)/analytics/page.tsx"
...
EOF
echo "✓ components/layout/Sidebar.tsx (Analytics added)"

echo ""
echo "✅ Phase 7 complete — Revenue Analytics module built!"
echo ""
echo "npm run dev — click Analytics in the sidebar"
echo ""
echo "What you'll see:"
echo "  · 4 KPI cards: projected May revenue, upcoming appointments, DAR, clean claim rate"
echo "  · Revenue trend chart with YoY toggle (monthly and weekly view)"
echo "  · Operational metrics with sparklines and benchmarks"  
echo "  · DAR by payer with benchmark markers"
echo "  · Payer mix shift analysis"
echo "  · Upcoming 4-week schedule with projected revenue table"
echo "  · Revenue opportunity summary callout"
echo ""
echo "git add . && git commit -m 'Phase 7: Revenue Analytics — projections, DAR, benchmarks, YoY'"